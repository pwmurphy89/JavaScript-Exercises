...
// From that object extract just the customers' email addresses and store them in 
// a new array. You will need to use methods such as map(), forEach() and/or concat() 
// to accomplish this.
...
const emails = customers.customers.reduce((allEmails, customerEmail) => {
    return allEmails.concat(customerEmail.contacts.email)
  },[]
)
console.log(emails);
